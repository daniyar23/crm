...
const file_proto_user_proto_rawDesc = "" +
	...
	"\x05Empty2|\n" +
	"\vUserService\x12;\n" +
	"\vGetUserByID\x12\x18.user.GetUserByIDRequest\x1a\x12.user.UserResponse\x120\n" +
	"\tListUsers\x12\v.user.Empty\x1a\x16.user.UserListResponseB>Z<github.com/daniyar23/crm/internal/feature/delivery/grpc;grpcb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	1, // 0: user.UserListResponse.users:type_name -> user.UserResponse
	0, // 1: user.UserService.GetUserByID:input_type -> user.GetUserByIDRequest
	3, // 2: user.UserService.ListUsers:input_type -> user.Empty
	1, // 3: user.UserService.GetUserByID:output_type -> user.UserResponse
	2, // 4: user.UserService.ListUsers:output_type -> user.UserListResponse
